import WebGLTileLayerCustom from "./WebGLTileLayerCustom.js"
...
export default class ShadedOpenLayers{
    ...
    updateSunPosition(){
        ...
        const sunPosition = SunCalc.getPosition(this.currentDate, coordinates[1], coordinates[0])
    ...
    startOpenLayers(mapElementId){
        ...
        const map = new ol.Map({
            ...
            layers: [tile],
            view: new ol.View({
                projection: new ol.proj.Projection({code: this.projection, units: "m"}),
                extent: this.extent,
