...
const Attributes = ol.renderer.webgl.TileLayer.Attributes
const Uniforms = ol.renderer.webgl.TileLayer.Uniforms
const getStringNumberEquivalent = ol.expr.gpu.getStringNumberEquivalent
const newCompilationContext = ol.expr.gpu.newCompilationContext
const uniformNameForVariable = ol.expr.gpu.uniformNameForVariable

const float_precision_factor = 100_000
const NB_VALUES_IN_BAND = 6;

class WebGLTileLayerRendererCustom extends ol.renderer.webgl.TileLayer {
...
export default class WebGLTileLayerCustom extends ol.layer.WebGLTile {
    constructor(options) {
        super(options)
